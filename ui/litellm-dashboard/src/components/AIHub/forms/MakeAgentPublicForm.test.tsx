...
describe("MakeAgentPublicForm", () => {
  ...
  it("should render the component", () => {
    ...
    expect(screen.getByText("将智能体设为公开")).toBeInTheDocument();
  ...
  it("should handle agent selection and navigation", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText("确认将智能体设为公开")).toBeInTheDocument();
    });
  });
  ...
  it("should display empty state when no agents are available", () => {
    ...
    expect(screen.getByText("暂无可选的智能体")).toBeInTheDocument();
  ...
  it("should display skills overflow text when agent has more than 3 skills", () => {
    ...
    // Should show "还有 2 项" text for the remaining skills
  ...
  it("should not render modal when visible is false", () => {
    ...
    expect(screen.queryByText("将智能体设为公开")).not.toBeInTheDocument();
  });
