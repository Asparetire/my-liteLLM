...
const makeTeamCreateFieldsSchema = (teamNameRequired: string) =>
  z.object({
  team_alias: z.string().min(1, teamNameRequired),
...
type TeamCreateFormValues = z.infer<ReturnType<typeof makeTeamCreateFieldsSchema>>;
...
const Teams: React.FC<TeamProps> = ({ accessToken, userID, userRole, premiumUser = false }) => {
  ...
  const teamCreateSchema = useMemo(
    () =>
      makeTeamCreateFieldsSchema(t("teamNameRequired")).superRefine((values, ctx) => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast.fromError(t("deleteError", { error: String(error) }));
    } finally {
  ...
  const handleCreate = async (formValues: Record<string, any>) => {
    try {
          ...
          if (typeof formValues.secret_manager_settings === "string") {
            if (formValues.secret_manager_settings.trim() === "") {
              ...
              try {
                ...
                throw new Error(t("secretParseError", { error: String(e) }));
              }
            }
          }
        }
      ...
      toast.fromError(t("createError", { error: extractProxyErrorMessage(error) }));
    }
  };
        ...
        <>
          ...
          <DeleteResourceModal
            ...
            alertMessage={(() => {
              ...
              return deleteKeyCount === 0 ? undefined : t("deleteWarning", { count: deleteKeyCount });
            })()}
            message={t("deleteMessage")}
            resourceInformationTitle={t("deleteInfoTitle")}
            resourceInformation={[
              { label: t("labelTeamId"), value: teamToDelete?.team_id, code: true },
              { label: t("labelTeamName"), value: teamToDelete?.team_alias },
              {
                label: t("labelKeys"),
                value: teamToDelete?.keys_count ?? teamToDelete?.keys?.length ?? 0,
              },
              { label: t("labelMembers"), value: teamToDelete?.members_with_roles?.length },
            ]}
          ...
          <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-y-auto sm:max-w-[1000px]">
            ...
            <TooltipProvider>
              <form onSubmit={form.handleSubmit(onCreateSubmit)}>
                <FieldGroup>
                  <FormField control={form.control} name="team_alias" label={t("labelTeamName")}>
                    {({ ref, value, ...field }) => (
                        ...
                        >
                          {({ id, value, onChange }) => (
                            <SearchSelect
                              ...
                              placeholder={
                                hasNoOrgs ? t("noOrganizations") : t("organizationPlaceholder")
                              }
                  ...
                  <FormField control={form.control} name="budget_duration" className="mt-8" label={t("resetBudget")}>
                    {({ id, value, onChange }) => (
                  ...
                  <FormField control={form.control} name="tpm_limit" label={t("tpmLimit")}>
                    {({ ref, value, ...field }) => (
                      <NumericalInput {...field} ref={ref} value={value ?? ""} step={1} width={400} />
                    )}
                  </FormField>
                  <FormField control={form.control} name="rpm_limit" label={t("rpmLimit")}>
                    {({ ref, value, ...field }) => (
                      <NumericalInput {...field} ref={ref} value={value ?? ""} step={1} width={400} />
                    )}
                  </FormField>
                    ...
                    <CollapsibleContent className="px-4 pb-3">
                      <FieldGroup>
                        <FormField
                          ...
                          name="team_id"
                          label={t("teamId")}
                          description={t("teamIdDescription")}
                        >
                        ...
                        <FormField
                          ...
                          label={labelWithHint(
                            t("teamMemberKeyDuration"),
                            t("teamMemberKeyDurationHint"),
                          )}
                        >
                          {({ ref, value, ...field }) => (
                            <UIInput {...field} ref={ref} value={value ?? ""} placeholder={t("keyDurationPlaceholder")} />
                          )}
                        </FormField>
                        <FormField
                          control={form.control}
                          ...
                          label={labelWithHint(
                            t("teamMemberRpmLimit"),
                            t("teamMemberRpmLimitHint"),
                          )}
                        >
                          {({ ref, value, ...field }) => (
                            <NumericalInput {...field} ref={ref} value={value ?? ""} step={1} width={400} />
                        ...
                        <FormField
                          ...
                          label={labelWithHint(
                            t("teamMemberTpmLimit"),
                            t("teamMemberTpmLimitHint"),
                          )}
                        >
                          {({ ref, value, ...field }) => (
                            <NumericalInput {...field} ref={ref} value={value ?? ""} step={1} width={400} />
                        ...
                        <FormField
                          ...
                          label={t("secretManagerSettings")}
                          description={
                            premiumUser
                              ? t("secretManagerPremiumDesc")
                              : t("secretManagerFreeDesc")
                          }
                        >
                          {({ ref, value, ...field }) => (
                            <Textarea
                        ...
                        <FormField
                          ...
                          label={labelWithHint(
                            ...
                            t("disableGlobalGuardrailsHint"),
                          )}
                          description={
                            premiumUser
                              ? t("disableGlobalGuardrailsPremiumDesc")
                              : t("disableGlobalGuardrailsFreeDesc")
                          }
                        >
                          {({ id, value, onChange }) => (
                            <Switch
                        ...
                        <FormField
                          ...
                          description={t("accessGroupsDescription")}
                        >
                          {({ value, onChange }) => (
                            <AccessGroupSelector
                              value={value}
                        ...
                        <FormField
                          ...
                          className="mt-8"
                          label={labelWithHint(
                            t("allowedVectorStores"),
                            t("allowedVectorStoresHint"),
                          )}
                          description={t("allowedVectorStoresDescription")}
                        >
                          {({ value, onChange }) => (
                            <VectorStoreSelector
                              onChange={onChange}
                        ...
                        <FormField
                          ...
                          label={
                            !premiumUser
                              ? labelWithHint(
                                  t("passThroughRoutes"),
                                  t("passThroughPremiumHint"),
                                )
                              : !isProxyAdminRole(userRole || "")
                                ? labelWithHint(
                                    t("passThroughRoutes"),
                                    t("passThroughNonAdminHint"),
                                  )
                                : t("passThroughRoutes")
                          }
                        >
                  ...
                  >
                    ...
                    <CollapsibleContent className="px-4 pb-3">
                      <FormField
                        ...
                        label={labelWithHint(
                          t("allowedMcpServers"),
                          t("allowedMcpServersHint"),
                        )}
                        description={t("allowedMcpServersDescription")}
                      >
                        {({ value, onChange }) => (
                          <MCPServerSelector
                            onChange={onChange}
                  ...
                  >
                    ...
                    <CollapsibleContent className="px-4 pb-3">
                      <FormField
                        ...
                        description={t("allowedAgentsDescription")}
                      >
                        {({ value, onChange }) => (
                          <AgentSelector
                            onChange={onChange}
                  ...
                  >
                    ...
                    <CollapsibleContent className="px-4 pb-3">
                      <FormField
                        ...
                        className="mt-4"
                        label={labelWithHint(
                          t("allowedSearchTools"),
                          t("allowedSearchToolsHint"),
                        )}
                        description={t("allowedSearchToolsDescription")}
                      >
                        {({ value, onChange }) => (
                          <SearchToolSelector
                            onChange={onChange}
                  ...
                  >
                    ...
                    <CollapsibleContent className="px-4 pb-3">
                      <FormField
                        ...
                        description={t("allowedSkillsDescription")}
                      >
                        {({ value, onChange }) => (
                          <SkillSelector
                            onChange={onChange}
