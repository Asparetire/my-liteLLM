                ...
                content={
                  <div>
                    ...
                    <div>
                      ...
                      {tag.usage > 0 && tag.usage < 1 ? "< 1 token" : `${formatNumberWithCommas(tag.usage, 0)} tokens`}
                    </div>
                  </div>
                }
              >
              ...
              return (
                <div className="relative z-floating p-3 bg-black/90 shadow-lg rounded-lg text-white max-w-xs">
                  <div className="space-y-1.5">
                    ...
                    <div className="text-sm">
                      <span className="text-muted-foreground">Spend: </span>
                      <span className="text-white font-medium">{formatNumberWithCommas(item?.spend, 0)} tokens</span>
                    </div>
                  </div>
                </div>
              );
