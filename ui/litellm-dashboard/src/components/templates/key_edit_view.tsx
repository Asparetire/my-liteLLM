...
export function KeyEditView({
  ...
  const t = useTranslations("keysEdit");
  ...
  return (
    <TooltipProvider>
      ...
      >
        <FieldGroup>
          <FormField control={form.control} name="key_alias" label={t("keyAlias")}>
          ...
          <FormField
            ...
            name="models"
            label={t("models")}
            description={isModelsDisabled ? t("modelsDisabledForType") : undefined}
          >
            {({ value, onChange, id }) => (
              <MultiSelect
                id={id}
          ...
          <Field>
            <FieldLabel htmlFor={keyTypeFieldId}>{t("keyType")}</FieldLabel>
            <KeyTypeSelect
              id={keyTypeFieldId}
          ...
          <FormField
            control={form.control}
            name="allowed_routes"
            label={labelWithHint(t("allowedRoutes"), t("allowedRoutesHint"))}
          >
            {(field) => (
              <Input
                {...field}
                value={(field.value as string | undefined) ?? ""}
                placeholder={t("allowedRoutesPlaceholder")}
              />
            )}
          </FormField>
          ...
          <KeyBudgetNumberField
            ...
            name="soft_budget"
            label={t("softBudget")}
            placeholder={t("softBudgetPlaceholder")}
          />
          ...
          <Field>
            <FieldLabel>
              {labelWithHint(t("budgetWindows"), t("budgetWindowsHint"))}
            </FieldLabel>
          ...
          <Field>
            <FieldLabel>
              {labelWithHint(t("budgetFallbacks"), t("budgetFallbacksHint"))}
            </FieldLabel>
          ...
          <FormField
            ...
            label={labelWithHint(t("throttleOnBudgetExceeded"), t("throttleHint"))}
          >
          ...
          <FormField
            ...
            label={labelWithHint(t("enablePromptCaching"), t("promptCachingHint"))}
          >
            {({ value, onChange, ref: _ref, ...field }) => (
              <Switch {...field} checked={Boolean(value)} onCheckedChange={onChange} />
            )}
          ...
          <FormField control={form.control} name="max_parallel_requests" label={t("maxParallelRequests")}>
            {({ ref: _ref, ...field }) => <NumericalInput {...field} value={field.value ?? ""} min={0} />}
          </FormField>

          <FormField control={form.control} name="model_tpm_limit" label={t("modelTpmLimit")}>
            {(field) => (
              <Textarea
                {...field}
                value={(field.value as string | undefined) ?? ""}
          ...
          <FormField control={form.control} name="model_rpm_limit" label={t("modelRpmLimit")}>
            {(field) => (
              <Textarea
                {...field}
                value={(field.value as string | undefined) ?? ""}
          ...
          <FormField
            ...
            label={labelWithHint(t("estimatedOutputTokens"), estimateTooltip.estimate)}
          >
            {({ ref: _ref, ...field }) => (
          ...
          <FormField
            ...
            label={labelWithHint(t("estimatedOutputTokensPerModel"), estimateTooltip.perModel)}
          >
            {(field) => (
              <Textarea
                {...field}
          ...
          <Field>
            <FieldLabel>
              {labelWithHint(t("perTagRateLimits"), t("perTagRateLimitsHint"))}
            </FieldLabel>
            <TagRateLimitEditor value={tagRateLimits} onChange={setTagRateLimits} />
          </Field>

          <FormField control={form.control} name="guardrails" label={t("guardrails")}>
            {({ value, onChange }) =>
              accessToken ? (
                <GuardrailSelector
                  onChange={onChange}
          ...
          <FormField
            ...
            label={labelWithHint(t("disableGlobalGuardrails"), t("disableGlobalGuardrailsHint"))}
          >
            {({ value, onChange, ref: _ref, ...field }) => (
          ...
          {canViewPolicies && (
            <FormField
              control={form.control}
              name="policies"
              label={labelWithHint(t("policies"), t("policiesHint"))}
            >
              {({ value, onChange }) =>
                accessToken ? (
                  <PolicySelector
          ...
          {canViewPrompts && (
            <FormField
              ...
              name="prompts"
              label={
                premiumUser ? t("prompts") : labelWithHint(t("prompts"), t("promptsPremiumHint"))
              }
            >
              {({ value, onChange, id }) => (
                <TagsInput
                  ...
                  placeholder={currentValuePlaceholder(
                    ...
                    t("promptsPremiumPlaceholder"),
                    t("promptsPlaceholder"),
                  )}
                />
              )}
            </FormField>
          ...
          <FormField
            ...
            label={labelWithHint(t("accessGroups"), t("accessGroupsHint"))}
          >
            {({ value, onChange }) => (
              <AccessGroupSelector
                value={value as string[] | undefined}
          ...
          <FormField
            ...
            label={
              premiumUser
                ? t("passThroughRoutes")
                : labelWithHint(t("passThroughRoutes"), t("passThroughPremiumHint"))
            }
          >
            {({ value, onChange }) => (
              <PassThroughRoutesSelector
                ...
                placeholder={currentValuePlaceholder(
                  ...
                  t("passThroughPremiumPlaceholder"),
                  t("passThroughPlaceholder"),
                )}
                disabled={!premiumUser}
              />
            )}
          ...
          <FormField control={form.control} name="vector_stores" label={t("vectorStores")}>
            {({ value, onChange }) => (
              <VectorStoreSelector
                onChange={onChange}
                value={value as string[] | undefined}
          ...
          <FormField control={form.control} name="mcp_servers_and_groups" label={t("mcpServers")}>
            {({ value, onChange }) => (
              <MCPServerSelector
                onChange={onChange}
          ...
          <FormField
            ...
            label={labelWithHint(t("organization"), t("organizationHint"))}
            description={hasProject ? t("organizationLocked") : undefined}
          >
            {({ value, onChange, id }) => (
          ...
          <FormField
            ...
            name="team_id"
            label={t("teamId")}
            description={hasProject ? t("teamLocked") : undefined}
          >
            {({ value, onChange, id }) => (
              <Select
          ...
          <Field>
            <FieldLabel>{t("routerSettings")}</FieldLabel>
          ...
          <FormField control={form.control} name="logging_settings" label={t("loggingSettings")}>
            {({ value, onChange }) => (
              <EditLoggingSettings
