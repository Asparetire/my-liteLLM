...
function UserRowActions({ user, onUserClick, onDeleteUser, onResetPassword, t }: UserRowActionsProps & { t: Translator }) {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
      ...
      <DropdownMenuContent align="end" className="w-48">
        ...
        <DropdownMenuItem
          onClick={() => void copyToClipboard(user.user_id, t("userIdCopied"))}
...
export const getUsersTableColumns = ({
  ...
  onResetPassword,
  t,
}: UsersTableColumnsDeps & { t: Translator }): ColumnDef<UserInfo>[] => {
  const baseColumns: ColumnDef<UserInfo>[] = [
    {
      id: "user_id",
      accessorKey: "user_id",
      meta: { title: t("colUserId") },
      header: ({ column }) => <DataTableSortHeader column={column} title={t("colUserId")} variant="header-cycle" />,
      size: 220,
      enableSorting: true,
      cell: ({ row }) => (
        <IdentityCell
    ...
    },
    {
      ...
      meta: { title: t("colEmail") },
      header: ({ column }) => <DataTableSortHeader column={column} title={t("colEmail")} variant="header-cycle" />,
      size: 220,
      enableSorting: true,
      cell: ({ row }) => (
    ...
    },
    {
      ...
      meta: { title: t("colRole") },
      header: ({ column }) => <DataTableSortHeader column={column} title={t("colRole")} variant="header-cycle" />,
      size: 160,
      enableSorting: true,
    ...
    },
    {
      ...
      meta: { title: t("colUserAlias") },
      header: t("colUserAlias"),
      size: 150,
      enableSorting: false,
      cell: ({ row }) => (
    ...
    },
    {
      ...
      meta: { title: t("colKeys"), skeleton: "badge" },
      header: t("colKeys"),
      size: 120,
      enableSorting: false,
      cell: ({ row }) => {
  ...
  return [
    createSelectionColumn<UserInfo>({
      rowAriaLabel: (row) => t("selectUserAria", { name: row.original.user_email || row.original.user_id }),
    }),
    ...baseColumns,
  ];
};
