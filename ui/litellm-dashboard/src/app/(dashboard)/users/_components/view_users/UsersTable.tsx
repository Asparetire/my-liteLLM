...
export function UsersTable({
  ...
  const filterLabels = useMemo<Record<string, string>>(
    () => ({
      user_id: t("filterUserId"),
      sso_user_id: t("filterSsoId"),
      user_role: t("filterRole"),
      team: t("filterTeam"),
    }),
    [t],
  );
          ...
          >
            {({ get, set }) => (
              <>
                ...
                <DataTableFilterField label={t("filterTeam")}>
                  <SearchSelect
                    options={teamOptions}
